        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <p className="text-muted-foreground mt-2">Manage inventory and track stock levels</p>
            </div>
            <button
              onClick={() => {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-border rounded-lg bg-background text-foreground focus:ring-2 focus:ring-primary/50 focus:border-primary"
                    required
                  />
                </div>
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2 border border-border rounded-lg bg-background text-foreground focus:ring-2 focus:ring-primary/50"
                  >
                    <option>kg</option>
              ...
              <table className="w-full">
                <thead className="bg-muted/50 border-b border-border">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-left text-sm font-semibold text-foreground">Reorder</th>
                    <th className="px-6 py-3 text-left text-sm font-semibold text-foreground">Cost/Unit</th>
                ...
                <tbody className="divide-y divide-border">
                  {materials.map((mat) => {
                    ...
                    return (
                      <tr key={mat.id} className="hover:bg-muted/50">
                        <td className="px-6 py-4 font-medium text-foreground">{mat.name}</td>
                        <td className="px-6 py-4 text-sm text-muted-foreground">{mat.unit}</td>
                        <td className="px-6 py-4 text-sm text-muted-foreground">{mat.current_stock.toFixed(2)}</td>
                        <td className="px-6 py-4 text-sm text-muted-foreground">{mat.reorder_level.toFixed(2)}</td>
                        <td className="px-6 py-4 text-sm font-medium text-primary">{'\u20B9'}{parseFloat(mat.cost_per_unit || 0).toFixed(2)}</td>
                        ...
                        <td className="px-6 py-4 text-sm text-muted-foreground">{mat.supplier || '-'}</td>
